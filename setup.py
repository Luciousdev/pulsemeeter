...
setup(
    name='pulsemeeter',
    version=VERSION,
    description='A pulseaudio audio routing application, forked from Gabriel Carneiro\'s pulsemeeter.',
    long_description=README,
    long_description_content_type="text/markdown",
    author='Lucy Gwen Puyenbroek',
    author_email='lucy@luciousdev.nl',
    license="MIT",
    ...
    url='https://github.com/Luciousdev/pulsemeeter',
